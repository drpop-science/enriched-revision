// V15.5.5 classroom presentation refinement ---------------------------------------------------
...
function walkthroughFrontView() {
  return {
    // Slightly wider than the normal close teaching view so the heater/base
    // remain visible above the tutorial banner.
    position: new THREE.Vector3(0, 4.95, 12.35),
